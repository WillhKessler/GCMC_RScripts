####---- READ ME ----###
# Use this script as a template for setting up and running batch processing jobs on a compute cluster with the SLURM job manager. 
# This utilizes parallel computing on a compute cluster.
# The required inputs are standardized for ALL functions defined in the Raster Extractions R source file. Update the REQUIRED INPUTS below, and the  
