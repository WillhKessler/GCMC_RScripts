...
filedirectory="S:\\GCMC\\Data\\Greenness\\CanopyCover/NLCD/nlcd_tcc_CONUS_1230mfs/"
...
##############################################################################################
CheckAllRastersPresent<-function(datefrequency,filedirectory){
  #List all Files
  ...
  if(isTRUE(all.equal(expected_metrics,actual_metrics))){
    message("All Expected Files are present, and there are no extraneous files. ")
  }else{
