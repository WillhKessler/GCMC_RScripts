...
files<-list.files("S:\\GCMC\\Data\\AirPollution\\PrimaryComponents\\temp_PM25",pattern=".*.rds$",recursive=TRUE,full.names=TRUE)
done<-list.files("S:\\GCMC\\Data\\AirPollution\\PrimaryComponents\\temp_PM25",pattern=".*.tif$",recursive=TRUE,full.names=TRUE)
